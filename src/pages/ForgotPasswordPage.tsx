...
import FormForgotPassword from '@/features/authentication/reset-password/FormForgotPassword';

const features = [
  { icon: Lock, text: 'Secure password recovery via email' },
  { icon: Shield, text: 'Link expires in 1 hour for safety' },
  { icon: KeyRound, text: 'Your account stays protected' },
];
          ...
          <div className="space-y-8!">
            <div className="space-y-4!">
              ...
              <p className="max-w-sm! text-base leading-relaxed text-white/70">
                Reset your password securely and get back to managing your team in
                minutes.
              </p>
            </div>
